...
function Add5Hours (time) {
  ...
  if (newTime.getHours() > 19) { /**Changed from 19 to 18*/   
    newTime.setDate(newTime.getDate() + 1);
    newTime.setHours(newTime.getHours() - 20); /**Changed from 20 to 19*/
  } else {
    newTime.setHours(newTime.getHours() + 4); /**Changed from 4 to 5*/
  }
