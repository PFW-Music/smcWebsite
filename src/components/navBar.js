...
import { Block, MailRounded } from "@material-ui/icons";
    ...
    <>
      <div className={classes.nav}>
        <div className={classes.mobileMenu}>
          ...
          <Drawer anchor="left" variant="temporary" open={open} onClose={toggleDrawer(false)} onOpen={toggleDrawer(true)}>
          ...
          <a class={classes.logo} href="https://pfw-smc.notion.site/pfw-smc/PFW-Sweetwater-Music-Center-17d134f1dd704a56909044ddb24d61ed">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 479.52 99.94">
              ...
              ></path>
              <path d="M475.41 29.14h.59c.39 0 .55-.15.55-.43s-.18-.43-.54-.43h-.62zm0 .57v1.35h-.71v-3.35h1.47c.73 0 1.13.4 1.13.92a.81.81 0 01-.49.79c.17.06.42.23.42.83v.17a2.52 2.52 0 000 .64h-.69a2.38 2.38 0 01-.07-.76v-.05c0-.36-.09-.54-.63-.54zM240.29 11.05V29.4l3.52 1.01v2.33h-11.22v-2.33l3.56-1.01V5.85l-1.96-2.08-2.22-.87V.4h7.53l17.29 21.96V3.92l-3.48-1.02V.4h11.14v2.5l-3.52 1.02v28.91h-3.21l-17.43-21.78zM270.58 3.92l-3.52-1.06V.4h13.2v2.46l-3.52 1.06v25.61l3.48 1.01v2.2h-13.2v-2.2l3.56-1.01V3.92zM285.41 3.92l-3.52-1.02V.4h13.86v2.5l-3.52 1.02 7.7 22 7.88-22-3.52-1.02V.4h11.4v2.5l-3.57 1.02-10.74 28.82h-5.23L285.41 3.92zM377.68 23.41h4.05l.93 4.49a11.78 11.78 0 006.47 1.94 14.26 14.26 0 001.8-.13 5.46 5.46 0 002.46-4.58c0-8.27-15.62-4.89-15.62-15.67C377.77 4 383 0 389.43 0a18.87 18.87 0 018.19 2v8.06h-4l-1.41-5.59a12.1 12.1 0 00-4.8-1.06 9.37 9.37 0 00-1.49.13 5 5 0 00-2.51 4.32c0 7.08 15.49 4.62 15.53 15.58 0 5.37-4.93 9.72-11.88 9.72a16.76 16.76 0 01-9.33-2.86zM405.03 3.92l-3.52-1.06V.4h13.2v2.46l-3.52 1.06v25.61l3.48 1.01v2.2h-13.21v-2.2l3.57-1.01V3.92zM427.71 3.92h-5.15l-1.41 6.2h-3.7V.4h26.94v9.72h-3.7l-1.36-6.2h-5.46V29.4l3.52 1.01v2.33h-13.25v-2.33l3.57-1.01V3.92zM458.94 20.02l-8.85-16.1-3.52-1.02V.4h13.86v2.5l-3.52 1.02 6.25 12.14 6.38-12.14-3.52-1.02V.4h11.45v2.5l-3.53 1.02-8.88 16.1v9.38l3.52 1.01v2.33h-13.21v-2.33l3.57-1.01v-9.38z"></path>
            </svg>
          </a>
        </div>
      </div>
